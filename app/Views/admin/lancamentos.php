            ...
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                ...
                <form class="row mb-4" method="get">
                    ...
                    <div class="col-12">
                        ...
                        <a href="<?= site_url('/admin/lancamentos') ?>" class="btn btn-warning " target="_blank">Limpar</a>
                    </div>
                </form>
                    ...
                    <div class="table-responsive p-0">
                        <?php if ($data_inicio || $data_fim || $tipo || $matricula): ?>
                            ...
                            <table class="table align-items-center mb-0">
                                ...
                                <tbody>
                                    <?php $tiposFormatados = ['cafe_manha' => 'Café da Manhã', 'cafe_madrugada' => 'Café da Madrugada', 'almoco' => 'Almoço', 'janta' => 'Janta']; ?>
