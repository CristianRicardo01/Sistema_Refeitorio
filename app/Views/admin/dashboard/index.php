...
<div class="container mt-4">
        ...
        <div class="col-md-4">
            <div class="card text-bg-primary mb-3">
                <div class="card-body">
                    ...
                    <p class="card-text fs-3"><?= esc($total) ?></p>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card text-bg-success mb-3">
                <div class="card-body">
                    <h5 class="card-title">Total Almoço</h5>
                    <p class="card-text fs-3"><?= esc($total_almoco) ?></p>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card text-bg-warning mb-3">
                <div class="card-body">
                    <h5 class="card-title">Total Janta</h5>
                    <p class="card-text fs-3"><?= esc($total_janta) ?></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md">
            <div class="card text-bg-primary mb-3">
                <div class="card-body">
                    <h5 class="card-title">Total hoje (<?= date('d/m/Y') ?>)</h5>
                    <p class="card-text fs-3"><?= esc($total_hoje) ?></p>
                </div>
            </div>
        </div>
        <div class="col-md">
            <div class="card text-bg-success mb-3">
                <div class="card-body">
                    <h5 class="card-title">Almoço hoje (<?= date('d/m/Y') ?>)</h5>
                    <p class="card-text fs-3"><?= esc($total_almoco_hoje) ?></p>
                </div>
            </div>
        </div>
        <div class="col-md">
            <div class="card text-bg-warning mb-3">
                <div class="card-body">
                    <h5 class="card-title">Janta hoje (<?= date('d/m/Y') ?>)</h5>
                    <p class="card-text fs-3"><?= esc($total_janta_hoje) ?></p>
                </div>
            </div>
        </div>
    </div>
