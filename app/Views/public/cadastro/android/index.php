...
<head>
    ...
    <title>Cadastro Refeitório - Android</title>
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="<?= base_url('/cadastrar') ?>">
                            ...
                            <div class="input-group input-group-outline mb-3">
                                ...
                                <input type="text" name="nome" class="form-control text-uppercase" required style="text-transform: uppercase;">
                            </div>

                            <div class="input-group input-group-outline mb-3">
                                <label class="form-label">Matrícula / CPF</label>
                                <input id="input_number" type="text" name="matricula" class="form-control" oninput="validateNumber(this)" required>
                            </div>
